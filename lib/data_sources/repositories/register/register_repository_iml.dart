...
class RegisterRepositoryIml extends RegisterRepository {
  ...
  RegisterRepositoryIml() {
    _dio = Dio(BaseOptions(baseUrl: HOST, receiveDataWhenStatusError: true))
  ...
  Future<String?> register(String phoneStr, bool resend) async {
    EasyLoading.show();
    var data = {'phone': phoneStr, 'resend': resend};
  ...
  Future<String?> confirmOTP(String phone, String code) async {
    ...
    try {
      responseUser =
          await _dio.post(RegisterRepository.CONFIRM_OTP, data: data);
