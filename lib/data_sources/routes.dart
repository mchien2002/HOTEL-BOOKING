...
class RoutesClass{
  ...
  static String getSearchFilterRoute(String location, String room) => "$searchFilter?location=$location?room=$room";
  ...
  static List<GetPage> routes = [
    // region SEARCH PAGE
    GetPage(page: () => const SearchHotelScreen(), name: search, transition: Transition.rightToLeft, transitionDuration: const Duration(milliseconds: 400)),
    ...
    // region SYSTEM PAGE
    GetPage(page: () => const SplashScreen(), name: home,),
    //endregion
