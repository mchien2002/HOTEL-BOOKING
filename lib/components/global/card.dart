...
class _CardLargeState extends State<CardLarge> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Card(
        ...
        child: InkWell(
          onTap: () => cardPress(context, widget.hotelData.id!),
          child: Column(
            children: [
  ...
  void cardPress(BuildContext context, String hotelID) async{
    Navigator.push(
      context, 
      MaterialPageRoute(builder: (context) => RoomDetailScreen(idHotel: hotelID,))
    );
  }
