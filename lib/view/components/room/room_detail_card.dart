...
class _RoomCardItemState extends State<RoomCardItem>
        ...
        child: Column(
          children: [
            ...
            moreBtn
                ...
                : const SizedBox(),
            moreBtn
                ? DetailCardBooking(widget.roomTypeData.currentPrice!)
                : Container(),
          ],
        ),
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              const Text("2 080 000 đ",
                  style: TextStyle(
                      height: 1.5,
                      decoration: TextDecoration.lineThrough,
                      color: Colors.grey)),
              Text("${oCcy.format(discount)} đ".replaceAll(',', ' '),
                  style: const TextStyle(
                      height: 1.5, fontSize: 17, color: colorD67402)),
              const Text("Mỗi đêm",
                  style: TextStyle(height: 1.5, fontSize: 12)),
              const SizedBox(
                height: 10,
  ...
  Widget DetailCardPrice(int cost) {
    return Row(
      ...
      children: [
        ...
        Text(
          oCcy.format(cost).toString().replaceAll(',', ' '),
          style: const TextStyle(color: colorD67402, fontSize: 20),
        ),
        const Text(" đ/đêm"),
        const SizedBox(
          width: 10,
        ...
        SizedBox(
          ...
          child: RaisedButton(
            ...
            child: Center(
              child: Image.asset(moreBtn
                  ? "assets/images/img_icon_up.png"
                  : "assets/images/img_icon_down.png"),
            ),
          ),
        ),
      ],
  ...
  Widget DetailCardBody(
    String imgUrl,
    String title,
    String numBerOfBed,
    String bedSize,
    List<Facilities> utilities,
  ) {
    return Row(
      children: [
        Container(
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(
                        "assets/images/img_icon_bed.png",
                        scale: 1.9,
                      ),
                      SizedBox(
  ...
  showUtilitiesBtn() {
    Get.toNamed(RoutesClass.getUtilitiesRoute(widget.roomTypeData.id!),
  ...
  onLoadHotelIDComplete(hotelData) {
    Get.back();
    Get.toNamed(RoutesClass.getRoomBookingRoute(hotelData.id),
        arguments: RoomBookingScreen(
            roomTypeData: widget.roomTypeData, hotelName: hotelData.name));
  }
}
