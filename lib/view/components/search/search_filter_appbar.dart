...
class SearchFilterAppBar extends StatelessWidget implements PreferredSizeWidget{
  const SearchFilterAppBar({
    Key? key, required this.dataLenght,
  }) : super(key: key);
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text("${context.watch<SearchProvider>().dateTimeRange.start.day}/${context.watch<SearchProvider>().dateTimeRange.start.month}/${context.watch<SearchProvider>().dateTimeRange.start.year} - ${context.watch<SearchProvider>().dateTimeRange.end.day}/${context.watch<SearchProvider>().dateTimeRange.end.month}/${context.watch<SearchProvider>().dateTimeRange.end.year}", 
