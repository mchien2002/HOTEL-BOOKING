...
class _SearchComponentState extends State<SearchComponent> {
        ...
        child: Column(
          ...
          children: <Widget>[
            TextBoxFieldSearch(
                ...
                searchProvider.location,
                RoutesClass.getSearchLocation(),
                const Icon(Icons.location_on)),
            const DateTimeBooking(),
            TextBoxFieldSearch(
                "Số phòng",
                "${searchProvider.rooms[0]} Người lớn - ${searchProvider.rooms[1]} Phòng - ${searchProvider.rooms[2]} Trẻ em",
                RoutesClass.getSearchQuantity(),
            ...
            SizedBox(
              ...
              height: 50,
              child: RaisedButton(
                onPressed: () => Get.toNamed(RoutesClass.getSearchFilterRoute(
                    searchProvider.location,
                    searchProvider.rooms[0].toString())),
  ...
  Widget TextBoxFieldSearch(
      String label, String hintText, screen, Icon iconBox) {
    return Column(
      children: [
        Row(
          children: [
